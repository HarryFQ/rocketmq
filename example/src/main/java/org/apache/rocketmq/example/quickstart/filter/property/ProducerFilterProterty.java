 ...
 */
package org.apache.rocketmq.example.quickstart.filter.property;
 ...
 * 过滤消息
 */
public class ProducerFilterProterty {
    public static void main(String[] args) throws MQClientException, InterruptedException, RemotingException, MQBrokerException {

        /*
         * 创建发送者
         */
        DefaultMQProducer producer = new DefaultMQProducer("my-filter-group");
        /**
         * 链接nameserver
         */
        ...
        for (int i = 0; i < orderStepList.size(); i++) {
            Message message = new Message("filterTopicProperty", "filter"+i%3, "i" + i, orderStepList.get(i).toString().getBytes());
            // 给消息绑定额外属性
            message.putUserProperty("myI",String.valueOf(i));
